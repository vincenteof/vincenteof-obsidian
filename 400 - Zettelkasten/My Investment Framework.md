...
针对长期投资 Alpha 组合，我的再平衡机制主要为 **从高波动资产平衡到低波动资产**, 比如从 BTC/ETH 平衡到美股，从个股平衡到 QQQ，从 QQQ 平衡到现金或者类似 SGOV 这样的现金等价物。当 Alpha 资产占据 Alpha 投资组合的超过 85％ 自动减仓。因为 Alpha 组合波动性较大，减仓机制有较大可能性可以达到标的本位的数量增加。
