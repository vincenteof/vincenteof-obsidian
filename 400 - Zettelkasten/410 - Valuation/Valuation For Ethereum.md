...
L2 可能是以太坊生态的历史产物，大多数 L2 只能达到 Stage1 阶段（中等可信程度，权威实体依然有能力控制网络），甚至坦言它们不会进入 Stage2 阶段（和以太坊本身一样 trustless，没有中心化实体可以控制）。而且以太坊本身已经升级得足够便宜，可以容纳目前程度的网络活动。L2 如果只是简单扩容已经没有意义，它们可以去成为应用链或者带有其他特殊能力的网络（ZK，极端高可用）。
