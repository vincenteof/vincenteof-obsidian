...
- [x] 阅读总结社区里的利用 AI 的正反讨论 #active ✅ 2026-01-26
一些需要思考或博弈的问题：
1. 合规带来的影响，不够 crypto native，但是现阶段老钱要进场必然需要合规
2. 现阶段收入模式单一，如何通过网络效应来避免内卷竞争
...
- [x] 分析泰达的 USAT 对 USDC 的影响 #active ✅ 2026-02-09

目前来看 USAT 的规模还很小，美国机构与 Defi 用的最多的还是 USDC。因为泰达本身的定位就是灰色美元，合规对他而言意义很小。
但这也反映了 CRCL 这个标的目前的问题，它不具有想 APPL 或者 TSLA 这种企业的垄断性。投资它需要时刻关注它自身在稳定币这个赛道的身位，即使稳定币本身可能是一个高确定高增长的赛道。稳定币的切换还是太简单了，CRCL 需要时间和砸钱产生网络效应，建立自身的护城河。

https://x.com/MengLayer/status/2016324959803736189
https://x.com/WinForKakei/status/2018507117213450554

- [x] 银行可以发合规稳定币对 CRCL 的影响 #active ✅ 2026-02-09

银行发的稳定币大概率不会是足额保证金的，它更会像是美元在链上的映射，那么一切关于它的监管都会和美元一样，包括 KYC 等机制。而 USDC 或 USDT，它们是稳定币而不是美元，我感觉可能这是目前监管刻意为之的模糊，Circle 并不是“银行的替代者”，而是：**银行体系无法、也不愿意承担的那一部分美元扩张工具**。稳定币是美债的巨大买盘，而且可以强化美元霸权。
...
IB 于 2026/1/16 支持 USDC 如今，不过大陆用户不支持。
...
总收入 + 储备收入：694M，同比增长 20%。储备收入653M，同比增长 17%。其他收入：42M ，同比增长 21M
扣除分销等成本后收入：约 287M，同比增长 24%，毛利率提升至 41.4%
Adjusted EBITDA：151 M，同比增长 24%，利润率约 53%
GAAP 净利润（持续经营）：55M美元
...
https://x.com/lufeieth/status/2005955861089239188
## competitor
